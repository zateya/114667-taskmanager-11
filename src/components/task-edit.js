...
import {COLORS, WEEK_DAYS, MIN_DESCRIPTION_LENGTH, MAX_DESCRIPTION_LENGTH, DefaultData} from "../constant.js";
...
export default class TaskEdit extends AbstractSmartComponent {
  ...
  _applyFlatpickr() {
    if (this._flatpickr) {
      ...
      // Чтобы их удалять, нужно вызывать метод `destroy` у созданного инстанса `flatpickr`.
      this._flatpickr.destroy();
      this._flatpickr = null;
    }
